...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen w-full flex bg-gym-black overflow-hidden font-sans">
      ...
      >
        <div ref={formRef} className="max-w-sm w-full mx-auto space-y-6 py-12">
          <div className="space-y-1">
            ...
            <p className="text-gray-400 text-sm">
              Join the Gymmers community and unlock your full potential.
            </p>
          </div>
      ...
      <div ref={rightSideRef} className="hidden lg:block w-1/2 relative h-full">
        ...
        <div className="absolute bottom-16 left-16 right-16 z-20 space-y-4">
          ...
          <p className="text-gray-300 font-medium">— Transformation Zone</p>
        </div>
      </div>
    </div>
  );
